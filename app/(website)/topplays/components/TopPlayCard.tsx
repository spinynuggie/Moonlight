...
export default function TopPlayCard({ score }: TopPlayCardProps) {
  ...
  const gradeColor = beatmap ? getGradeColor(score.grade) : "";

  return (
    <div className="relative">
      {/* Skeleton base layer — stays visible until content covers it */}
      <TopPlayCardSkeleton />

      {/* Content layer — fades in on top when beatmap data loads */}
      {beatmap && (
